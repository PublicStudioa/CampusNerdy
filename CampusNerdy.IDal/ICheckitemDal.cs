...
namespace nameSpace
{
    ...
    /// 
    /// </summary>
    public interface ICheckitemDal
    {
        ...
        bool existModeByID(string paraID);
        #endregion
        ...
        bool deleteModeByID(string paraID);
        /// <summary>
        /// 删除数据
        /// </summary>
        ...
        /// <returns>true：删除成功，false：不存在该记录</returns>
        bool deleteMode(tb_CheckItem paraTb_Checkitem);
        #endregion
        ...
        bool updateMode(tb_CheckItem paraTb_Checkitem);
        #endregion
        ...
        bool addMode(tb_CheckItem paraTb_Checkitem);
        #endregion
        ...
        tb_CheckItem getModelByID(string paraID);
        #endregion
        ...
        List<tb_CheckItem> getListByCheckoutid(string paraCheckoutid);
        /// <summary>
        /// 查询表单，获取模型实体集合
        /// </summary>
        /// <returns>查询成功返回符合条件的集合，否则返回空集合</returns>
        List<tb_CheckItem> getList();
        #endregion
