...
namespace CampusNerdy.IDal
{
    ...
    public interface IDictionaryDal
    {
        ...
        bool existModeByDicid(string paraDicid);
        #endregion
        ...
        bool deleteModeByDicid(string paraDicid);
        /// <summary>
        /// 删除数据
        /// </summary>
        /// <param name="paraTb_Dictionary"></param>
        /// <returns>true：删除成功，false：不存在该记录</returns>
        bool deleteMode(tb_Dictionary paraTb_Dictionary);
        #endregion
        ...
        bool updateMode(tb_Dictionary paraTb_Dictionary);
        #endregion
        ...
        bool addMode(tb_Dictionary paraTb_Dictionary);
        #endregion
        ...
        tb_Dictionary getModelByDicid(string paraDicid);
        /// <summary>
        /// 查询表单，获取单个数据模型对象
        /// </summary>
        /// <param name="paraDickey">键</param>
        /// <returns>null为没找到匹配对象，否则返回单行数据模型对象</returns>
        tb_Dictionary getModelByDickey(string paraDickey);
        #endregion
        ...
        List<tb_Dictionary> getListByDicid(string paraDicid);
        /// <summary>
        /// 查询表单，获取模型实体集合
        /// </summary>
        /// <param name="paraDicprekey">父键</param>
        /// <returns>查询成功返回符合条件的集合，否则返回空集合</returns>
        List<tb_Dictionary> getListByDicprekey(string paraDicprekey);
        /// <summary>
        /// 查询表单，获取模型实体集合
        /// </summary>
        /// <param name="paraDictype">字典类型</param>
        /// <returns>查询成功返回符合条件的集合，否则返回空集合</returns>
        List<tb_Dictionary> getListByDictype(string paraDictype);
        /// <summary>
        /// 查询表单，获取模型实体集合
        /// </summary>
        /// <returns>查询成功返回符合条件的集合，否则返回空集合</returns>
        List<tb_Dictionary> getList();
        #endregion
